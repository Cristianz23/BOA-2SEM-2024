<!-- Modal -->
<div class="modal fade" id="generarUsuarioDocente<?= $docente['idDocente']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Generar Usuario Docente <?= $docente['nombre']; ?></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="container">
        <form action="../controllers/usuario.controller.php" method = "post">
            <input type="hidden" name="IdTipoUser" id="IdTipoUser" value="<?= $docente['idDocente']; ?>">
            
            <div class="mb-3">
                <label for="nombre" class="form-label">Nombre</label>
                <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $docente['nombre']; ?>" disabled>
                <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $docente['nombre']; ?>" hidden>
            </div>
